...
export default function ExportButtons({ debts, payoffResult, minimumOnlyResult, extraPayment, strategy, fireInputs, fireComparison }) {
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-text-muted text-xs mt-1">
            Download your complete payoff plan with summary, schedule, milestones, and FIRE projections.
          </p>
        </div>
        <div className="flex gap-3">
          ...
          <button
            ...
            className="flex items-center gap-2 px-5 py-2.5 text-sm font-medium rounded-xl bg-gradient-to-r from-red-600 to-red-500 text-white hover:opacity-90 disabled:opacity-50 transition-all shadow-lg shadow-red-500/10"
